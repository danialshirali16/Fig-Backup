  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <ChevronDownIcon className="cn-select-trigger-icon pointer-events-none" aria-hidden="true" />
    ...
    >
      <span className="cn-select-item-indicator">
        <SelectPrimitive.ItemIndicator>
          <CheckIcon className="cn-select-item-indicator-icon pointer-events-none" aria-hidden="true" />
        </SelectPrimitive.ItemIndicator>
      </span>
