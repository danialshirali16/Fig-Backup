<p align="center">
  <img src="docs/screenshots/icon-256.png" width="88" alt="Значок Fig Backup">
</p>
...
<p align="center">
  <img src="docs/screenshots/cover.png" alt="Обложка Fig Backup — нативные резервные копии из Figma, бесплатное настольное приложение для macOS и Windows" width="100%">
</p>
...
| Платформа | Загрузка |
| --- | --- |
| macOS (Apple Silicon) | [`Fig-Backup-macOS.zip`](https://github.com/danialshirali16/Fig-Backup/releases/latest) — имя файла содержит номер версии |
| Windows 10/11 (x64) | [`Fig-Backup-Windows-x64.zip`](https://github.com/danialshirali16/Fig-Backup/releases/latest/download/Fig-Backup-Windows-x64.zip) — прямая загрузка |

Каждый релиз также включает файл `SHA256SUMS.txt` с контрольными суммами обоих файлов.

При первом запуске Fig Backup скачивает Chromium (около 150 МБ) в качестве резервного браузера. Приложение macOS не подписано — возможно, потребуется щёлкнуть по нему правой кнопкой мыши и выбрать **Open**. С установкой поможет [руководство по устранению неполадок](docs/TROUBLESHOOTING.md).
...
- Файлы Figma Design, FigJam и Slides сохраняются в их родных форматах:<br>
  <img src="docs/screenshots/figma-file-design.png" height="20" alt="Файлы Figma Design">
  <img src="docs/screenshots/figma-file-figjam.png" height="20" alt="Файлы FigJam">
  <img src="docs/screenshots/figma-file-slides.png" height="20" alt="Файлы Figma Slides">
...
| --- | --- |
| <img src="docs/screenshots/setup-wizard.png" alt="Мастер настройки — шаг входа через браузер"> | <img src="docs/screenshots/browse-light.png" alt="Просмотр папок и файлов команды"> |
| **Менеджер загрузок** | **Тёмная тема** |
| <img src="docs/screenshots/download-manager.png" alt="Менеджер загрузок с идущей очередью"> | <img src="docs/screenshots/dark-mode.png" alt="Экран просмотра в тёмной теме"> |
...
Проблемы с установкой, входом или загрузкой? Читайте [руководство по устранению неполадок](docs/TROUBLESHOOTING.md). Сообщения об ошибках и вклад приветствуются; см. [CONTRIBUTING.md](CONTRIBUTING.md).
...
<p align="center">
  <img src="docs/screenshots/donate-qr.png" alt="QR-код для пожертвований в биткоинах" width="180"><br>
